...
function setCookieChoice(choice) {
    var expirationDate = new Date(); // Date d'expiration pour le cookie
    expirationDate.setDate(expirationDate.getDate() + 30); // Expiration dans 30 jours
    ...
    if (choice === "accepted" || choice === "declined") {
        ...
        setExpiration(expirationDate.getTime()); // Enregistre également la date d'expiration des cookies
    }
}
...
window.addEventListener('scroll', () => {
    ...
    // Vérifier si l'utilisateur est arrivé en bas de la page
